// Programa   : BCOCANARIAS
// Fecha/Hora : 29/04/2004 14:32:22
// Propósito  : Generar Archivo TXT Banco Canarias
// Creado Por : Vicente Camesella
...
PROCE MAIN(oTable,cFile,oMeter,oSay,lEdit)
  ...
  IF EMPTY(oTable)
   ...
   cSql:= " SELECT CODIGO,APELLIDO,NOMBRE,BANCO_CTA,CEDULA,CESTA,REC_MONTO FROM NMRECIBOS "+;
  ...
  WHILE !oTable:Eof()
     ...
     ENDIF
       ...
       cLine:= oTable:TIPO_CED+;
               ...
               "10000003"+;
	         FILLZERO(STR(oTable:REC_MONTO*100,13,0),15)+;
		   CHR(13)+CHR(10)
